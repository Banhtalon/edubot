...
*   **Chức năng mới nâng cấp:**
    ...
    *   **Mã mẫu dạng đục lỗ (Fill-in-the-blank):** Cải tiến `starterCode` thành dạng đục lỗ với ký tự `___` ở các vị trí quan trọng (tên hàm, từ khóa, tham số) chiếm 40% - 50% mã nguồn để học sinh điền và hoàn thành.
